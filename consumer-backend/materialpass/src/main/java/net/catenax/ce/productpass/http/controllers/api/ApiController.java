...
public class ApiController {
    ...
    public Response getPassport(
        ...
        // Initialize response and variables
        Response response = httpTools.getResponse();
        ...
        SubModel subModel = aasService.searchSubModel(idType, assetId, index);
        String connectorId = subModel.getIdShort();
        String connectorAddress = subModel.getEndpoints().get(index).getProtocolInformation().getEndpointAddress();
        ...
        Transfer transfer = dataService.initiateTransfer(transferRequest);
