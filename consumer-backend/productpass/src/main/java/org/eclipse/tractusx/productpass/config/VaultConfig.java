...
import org.eclipse.tractusx.productpass.exceptions.ConfigException;
...
public class VaultConfig extends AbstractVaultConfiguration {
    ...
    public ClientAuthentication clientAuthentication() {
        try{
            this.dataDir = FileUtil.createDataDir("VaultConfig");
            ...
            if(StringUtil.isEmpty(token)){
                LogUtil.printFatal("Please add the Vault token to ["+filePath+"] file, in order to start the application.");
