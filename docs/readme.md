...
> **IMPORTANT!**: Before you start with the architecture docs please take a look a the business context from the application use case. In this way you will be able to understand much better the further documentation.
