...
import org.eclipse.tractusx.digitalproductpass.core.models.catenax.EdcDiscoveryEndpoint;
...
public class DtrSearchManager {
    ...
    public void searchEndpoint(String processId, String bpn, String endpoint) {
        ...
        if (contractOffers instanceof LinkedHashMap) {
            ...
            if (dataset != null) {
                ...
                Selection<Dataset, org.eclipse.tractusx.digitalproductpass.core.models.negotiation.policy.Set> contractAndPolicy = getDtrDataset(datasets);
     ...
     */
    public Selection<Dataset, org.eclipse.tractusx.digitalproductpass.core.models.negotiation.policy.Set> getDtrDataset(Map<String, Dataset> datasets) {
        try {
     ...
     */
    private Runnable createAndSaveDtr(Selection<Dataset, org.eclipse.tractusx.digitalproductpass.core.models.negotiation.policy.Set> contractAndPolicy, Map<String, Dataset> datasets, String bpn, String providerBpn, String connectionUrl, String processId) {
        return new Runnable() {
            @Override
            public void run() {
                try {
