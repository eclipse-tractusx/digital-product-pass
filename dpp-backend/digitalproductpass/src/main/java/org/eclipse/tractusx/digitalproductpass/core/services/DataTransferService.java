...
import org.eclipse.tractusx.digitalproductpass.core.models.negotiation.catalog.Catalog;
import org.eclipse.tractusx.digitalproductpass.core.models.negotiation.catalog.CatalogRequest;
import org.eclipse.tractusx.digitalproductpass.core.models.negotiation.catalog.Dataset;
import org.eclipse.tractusx.digitalproductpass.core.models.negotiation.catalog.Policy;
...
import org.eclipse.tractusx.digitalproductpass.core.models.negotiation.response.NegotiationTransferResponse;
...
public class DataTransferService extends BaseService {
     ...
     *
     */
    public NegotiationRequest buildRequest(Dataset dataset, String endpoint, String providerBpn, org.eclipse.tractusx.digitalproductpass.core.models.negotiation.policy.Set policy) {
     ...
     *
     */
    public org.eclipse.tractusx.digitalproductpass.core.models.negotiation.policy.Set selectPolicyByIndex(Object policies, Integer defaultIndex){
        if(policies instanceof LinkedHashMap){
            return org.eclipse.tractusx.digitalproductpass.core.models.negotiation.policy.Set.build(policies);
        }
        List<LinkedHashMap> policyList = (List<LinkedHashMap>) jsonUtil.bindObject(policies, List.class);
        return org.eclipse.tractusx.digitalproductpass.core.models.negotiation.policy.Set.build(policyList.get(defaultIndex)); // Get fist policy from the list to resolve the conflict
    }
    ...
    public Policy buildOffer(Dataset dataset, Integer defaultIndex, String bpn) {
        ...
        if(rawPolicy instanceof LinkedHashMap){
            ...
            policy = org.eclipse.tractusx.digitalproductpass.core.models.negotiation.policy.Set.build(policyList.get(defaultIndex)); // Get fist policy from the list to resolve the conflict
        }
     ...
     *
     */
    public Policy buildOffer(Dataset dataset, org.eclipse.tractusx.digitalproductpass.core.models.negotiation.policy.Set policy, String bpn) {
