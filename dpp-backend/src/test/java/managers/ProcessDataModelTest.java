...
class ProcessDataModelTest {
    ...
    void setStateThrowsDataModelExceptionByNonexistentProcessId() {
        ...
        assertEquals("[org.eclipse.tractusx.digitalproductpass.backend.managers.ProcessDataModel] The process does not exists!", exception.getMessage());
    }
    ...
    void startProcessThrowsDataModelExceptionByNonexistentProcessId() {
        ...
        assertEquals("[org.eclipse.tractusx.digitalproductpass.backend.managers.ProcessDataModel] It was not possible to start the process, " +
                "[org.eclipse.tractusx.digitalproductpass.backend.managers.ProcessDataModel] The process does not exists!", exception.getMessage());
    }
}
