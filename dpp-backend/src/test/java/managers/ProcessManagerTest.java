...
import org.eclipse.tractusx.digitalproductpass.backend.config.ProcessConfig;
import org.eclipse.tractusx.digitalproductpass.backend.exceptions.ManagerException;
import org.eclipse.tractusx.digitalproductpass.backend.managers.ProcessDataModel;
import org.eclipse.tractusx.digitalproductpass.backend.managers.ProcessManager;
import org.eclipse.tractusx.digitalproductpass.backend.models.catenax.Dtr;
import org.eclipse.tractusx.digitalproductpass.backend.models.dtregistry.DigitalTwin;
import org.eclipse.tractusx.digitalproductpass.backend.models.edc.EndpointDataReference;
import org.eclipse.tractusx.digitalproductpass.backend.models.http.requests.Search;
import org.eclipse.tractusx.digitalproductpass.backend.models.http.responses.IdResponse;
import org.eclipse.tractusx.digitalproductpass.backend.models.irs.JobHistory;
import org.eclipse.tractusx.digitalproductpass.backend.models.manager.History;
import org.eclipse.tractusx.digitalproductpass.backend.models.manager.Process;
import org.eclipse.tractusx.digitalproductpass.backend.models.manager.Status;
import org.eclipse.tractusx.digitalproductpass.backend.models.negotiation.catalog.Dataset;
import org.eclipse.tractusx.digitalproductpass.backend.models.negotiation.request.NegotiationRequest;
import org.eclipse.tractusx.digitalproductpass.backend.models.negotiation.request.TransferRequest;
import org.eclipse.tractusx.digitalproductpass.backend.models.negotiation.response.Negotiation;
import org.eclipse.tractusx.digitalproductpass.backend.models.negotiation.response.Transfer;
...
class ProcessManagerTest {
    ...
    void getProcessThrowsManagerException() {
        ...
        assertEquals("[org.eclipse.tractusx.digitalproductpass.backend.managers.ProcessManager] It was not possible to get process [null], " +
                        "[org.eclipse.tractusx.digitalproductpass.backend.managers.ProcessManager] Failed to load Process DataModel!, " +
    ...
    void checkProcessThrowsManagerException() {
        ...
        assertEquals("[org.eclipse.tractusx.digitalproductpass.backend.managers.ProcessManager] It was not possible to check if process exists [null], " +
        ...
        assertEquals("[org.eclipse.tractusx.digitalproductpass.backend.managers.ProcessManager] It was not possible to check if process exists ["+ testProcessId +"], " +
                        "[org.eclipse.tractusx.digitalproductpass.backend.managers.ProcessManager] Failed to load Process DataModel!, " +
                        "Cannot invoke \"jakarta.servlet.http.HttpServletRequest.getSession()\" because \"httpRequest\" is null",
                exception.getMessage());
    }
    ...
    void setProcessThrowsManagerException() {
        ...
        assertEquals("[org.eclipse.tractusx.digitalproductpass.backend.managers.ProcessManager] It was not possible to set process ["+testProcessId+"], " +
                        "[org.eclipse.tractusx.digitalproductpass.backend.managers.ProcessManager] Failed to load Process DataModel!, " +
                        "Cannot invoke \"jakarta.servlet.http.HttpServletRequest.getSession()\" because \"httpRequest\" is null",
                exception.getMessage());
    }
    ...
    void setStatusThrowsManagerException() {
        ...
        assertEquals("[org.eclipse.tractusx.digitalproductpass.backend.managers.ProcessManager] It was not possible to create/update the status file, " +
                "Cannot invoke \"String.isEmpty()\" because \"segment\" is null", exception.getMessage());
    }
    ...
    void deleteSearchDirThrowsManagerException() {
        ...
        assertEquals("[org.eclipse.tractusx.digitalproductpass.backend.managers.ProcessManager] It was not possible to create/update the search in search status file, " +
                        "[org.eclipse.tractusx.digitalproductpass.backend.managers.ProcessManager] Temporary process file does not exists for id [1000]!"
                , exception.getMessage());
    }
