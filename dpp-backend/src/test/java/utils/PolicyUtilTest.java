...
@SpringBootTest(classes = {utils.JsonUtil.class, utils.PolicyUtil.class, utils.FileUtil.class, org.eclipse.tractusx.digitalproductpass.backend.config.DtrConfig.class, org.eclipse.tractusx.digitalproductpass.backend.config.PassportConfig.class})
