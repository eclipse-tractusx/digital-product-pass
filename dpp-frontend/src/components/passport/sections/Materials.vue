      ...
      <v-row class="section">
        ...
        >
          ...
          <template v-if="propsData.substancesOfConcern">
            <template
              v-for="(attr, key) in propsData.substancesOfConcern
                .substanceOfConcern"
              :key="key"
            >
              <Field
        ...
        <v-col
          ...
          md="4"
          class="pa-0 ma-0"
          v-if="callHasContent(propsData.materialComposition)"
        >
          <template v-if="propsData.materialComposition">
            <template
              v-for="attr in propsData.materialComposition.chemicalMaterial"
              :key="attr"
            >
              <Field
                :icon="callIconFinder('name')"
        ...
        <template v-if="propsData.composition">
        ...
        <v-col
          ...
          md="4"
          class="pa-0 ma-0"
          v-if="callHasContent(propsData.active)"
        >
