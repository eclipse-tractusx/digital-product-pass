<template>
  ...
  <div class="section-content" :class="[toggle ? 'hidden' : '']">
    <div class="sub-section-container">
      ...
      <Field label="Minimal voltage with temperature ranges when relevant" v-bind:tempMax="
...
" v-bind:value="
  parametersOfTheBattery.minimalVoltageWithTemperatureRangesWhenRelevant
    .value
" />
      <Field label="Nominal voltage with temperature ranges when relevant" v-bind:tempMax="
...
" v-bind:value="
  parametersOfTheBattery.nominalVoltageWithTemperatureRangesWhenRelevant
    .value
" />
      <Field label="Maximum voltage with temperature ranges when relevant" v-bind:tempMax="
...
" v-bind:value="
  parametersOfTheBattery.maximumVoltageWithTemperatureRangesWhenRelevant
    .value
" />
      <Field label="Original power capability with temperature ranges when relevant" v-bind:tempMax="
...
" />
      ...
      <Field label="Capacity threshold for exhaustion"
        v-bind:unit="parametersOfTheBattery.capacityThresholdForExhaustion.unit" v-bind:value="
          parametersOfTheBattery.capacityThresholdForExhaustion.value
        " />

      <Field label="Temperature range the battery can withstand when not in use" v-bind:tempRangeMax="
        parametersOfTheBattery
...
" />
    ...
    <div class="sub-section-container">
      ...
      <Field label="Power capability at 80% state of charger" v-bind:unit="
...
" />
      <Field label="Power capability at 20% state of charge" v-bind:unit="
...
" />
    ...
    <div class="sub-section-container">
      ...
      <Field label="Ratio between maximum allowed battery power (W) and battery energy
          (Wh)" v-bind:unit="
            parametersOfTheBattery
...
" />
      ...
      <Field label="Internal Resistance Increase: Pack"
        v-bind:unit="parametersOfTheBattery.internalResistanceIncreasePack.unit" v-bind:value="
      ...
      <Field label="Depth of discharge in the cycle-life test" v-bind:unit="
