    ...
    <div class="main">
      ...
      <div class="container">
        ...
        <select id="selectOffer" v-model="selectedContract" class="form-select center ddl" placeholder="Select Offer"
          ...
          <option v-for="(offer, index) in provider.contractOffers" v-bind:key="index">{{  offer  }}
          </option>
        </select>
      </div>
      <br />
      <div class="container">
        ...
        <select id="selectBattery" v-model="selectedBattery" class="form-select center ddl" placeholder="Select Battery"
          ...
          <option v-for="(battery, id) in provider.batteries" v-bind:key="id" :value="battery.id">{{  battery.name  }}
          </option>
        </select>
      </div>
      <br />
